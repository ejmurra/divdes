...
module.exports = (function () {
  ...
  _createClass(SpriteUtilities, [{
    ...
    value: function addStatePlayer(sprite) {
      ...
      function playAnimation(sequenceArray, finishFrame, finalFunc) {
        if (finalFunc) this.finalFunc = finalFunc;
        if (finishFrame) {
          this._onComplete = finishFrame;
        } else {
          this._onComplete = 0;
        }
      ...
      function advanceFrame() {
        ...
        if (frameCounter < numberOfFrames + 1) {
          ...
          if (sprite.loop) {
            ...
            sprite.gotoAndStop(this._onComplete);
            if (this.finalFunc) {
              console.log(this);
              this.finalFunc();
